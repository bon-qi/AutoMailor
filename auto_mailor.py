...
class AutoMailor(object):
    ...
    def send_to(self, 
                receiver:list=['2308224300@qq.com'],
        ...
        self.quit()      
        print(f"[{fg.yellow}INFO {get_time()}{fg.black}] Sent: [", mail_content, "] to ", receiver)
    def quit(self):
        self.smtp.quit()
...
if __name__ == "__main__":
    ...
    for i in range(300):
        automail_qi.send_to(
            receiver= ["1287974345@qq.com", "2834637388@qq.com", "961850163@qq.com", "2308224300@qq.com"],
            mail_content="你好呀",
            mail_title="你好呀"
        )
        time.sleep(2)
